...
var btnnumbers = createElements('button', 'btn-fluid btn-light text-md-center text-sm-left text-xs-left p-md-3 p-sm-4 p-xs-4 col-2', 10);
...
var modulus=createButton('%','%',`appendNumber('%')`);
...
divarr[5].append(modulus, btnnumbers[0],equals,division);
...
function createButton(txt, val, fn) {
    ...
    a.setAttribute('class', 'btn-fluid btn-light text-md-center text-sm-left text-xs-left p-md-3 p-sm-4 p-xs-4 col-2');
